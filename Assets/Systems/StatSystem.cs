...
public class StatSystem : FSystem
{
    ...
    /// Représente la fenêtre d'affichage des attributs de l'oiseau séléctionné
    /// </summary>
    private Family _StatFeedFamily = FamilyManager.getFamily(new AllOfComponents(typeof(StatFeed)));

    /// <summary>
    /// The select family
    /// Représente l'oiseaux pointé par la souris mais pas séléctionné
    /// </summary>
    ...
    /// <summary>
    /// The unselect family
    /// Représente l'oiseaux qui est séléctionné mais pas pointé par la souris
    /// </summary>
    ...
    /// <summary>
    /// a
    /// Représente les attributs de l'oiseau séléctionné
    /// </summary>
    private Attribut a;

    /// <summary>
    /// Initializes a new instance of the <see cref="StatSystem"/> class.
    /// Initialise la fenêtre d'affichage des attributs de l'oiseau séléctionné
    /// </summary>
    public StatSystem()
    {
    ...
    /// Récupére les attributs de l'oiseaux séléctionné pour les afficher sur la fenêtre d'affichage
    /// </summary>
